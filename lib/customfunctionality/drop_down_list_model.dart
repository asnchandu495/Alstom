...
List<int> getDaysValue(Options values) {
...
List<int> getFeetValue(dynamic values) {
  Options options = values as Options;
  List<int> feetValues = [];
  if (options.feet != null) {
    for (var element in options.feet!) {
      feetValues.add(element);
    }
  }
  return feetValues;
}

List<int> getInchValue(dynamic values) {
  Options options = values as Options;
  List<int> inchValues = [];
  if (options.inch != null) {
    for (var element in options.inch!) {
      inchValues.add(element);
    }
  }
  return inchValues;
}
