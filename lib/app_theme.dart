...
class MyTheme {
  ...
  static const Color kBgColor =  Color(0xffE5E5E5);
  ...
  static Color kBorderUser = const Color(0xFFB3B9C6);
  static Color kSummaryLightShade = const Color(0xFFE9E8F5);
  static Color kSummaryDarkShade = const Color(0xFFDDDCF3);

  // static Color kBorderBot = Color(0xFFB3B9C6);

  static const TextStyle splashScreenTitle = TextStyle(
    color: kBlueShade,
    fontSize: 22,
  ...
  static const TextStyle diagramTitle = TextStyle(
    color: kBlueShade,
    fontSize: 18,
    fontWeight: FontWeight.w700,
    letterSpacing: 1,
  ...
  static const TextStyle summaryCaption = TextStyle(
    color: MyTheme.kBlueShade,
    fontSize: 14,
    fontWeight: FontWeight.w700,
  );
  ...
  static const TextStyle chatTime = TextStyle(
      color: MyTheme.kChatTimeColor, fontSize: 12, fontWeight: FontWeight.w400);

  static const TextStyle chatConversation = TextStyle(
      color: MyTheme.kChatTimeColor, fontSize: 14, fontWeight: FontWeight.w400);

  static const TextStyle summaryTitle = TextStyle(
      color: MyTheme.kChatTimeColor, fontSize: 16, fontWeight: FontWeight.w600);
